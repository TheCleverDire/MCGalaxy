...
{
    public sealed class CmdViewOps : Command2
    {
        public override string name { get { return "ViewOps"; } }
        ...
        public override CommandPerm[] ExtraPerms
        {
            get
            {
                return new[] { new CommandPerm(LevelPermission.Operator, "are Ops"), new CommandPerm(LevelPermission.Operator, "can read Op messages") };
            }
        }
        ...
        public override void Use(Player p, string message, CommandData data)
        {
            ...
            {
                ItemPerms perms = CommandExtraPerms.Find("ViewOps", 1);
