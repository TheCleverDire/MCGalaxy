...
{
    public sealed class CmdViewStaff : Command2
    {
        public override string name { get { return "ViewStaff"; } }
        public override string type { get { return "information"; } }

        public override CommandPerm[] ExtraPerms { get { return new[] { new CommandPerm(LevelPermission.Moderator, "are staff"), new CommandPerm(LevelPermission.Moderator, "can read staff messages") };        
            }
        }
        ...
        public override void Use(Player p, string message, CommandData data)
        {
            ...
            {
                ItemPerms perms = CommandExtraPerms.Find("ViewStaff", 1);
