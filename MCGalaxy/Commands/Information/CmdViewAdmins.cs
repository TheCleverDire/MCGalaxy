...
{
    public sealed class CmdViewAdmins : Command2
    {
        public override string name { get { return "ViewAdmins"; } }
        ...
        public override CommandPerm[] ExtraPerms
        {
            get
            {
                return new[] { new CommandPerm(LevelPermission.Admin, "are admins"), new CommandPerm(LevelPermission.Admin, "can read admin messages") };
            }
        }
        ...
        public override void Use(Player p, string message, CommandData data)
        {
            ...
            {
                ItemPerms perms = CommandExtraPerms.Find("ViewAdmins", 1);
